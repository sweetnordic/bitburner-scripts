...
export async function main(ns) {
	...
	var levelUpgrades = 5, ramUpgrades = 1, coreUpgrades = 1;
	if (ns.argslength == 0) { ns.tprint("usage: run " + ns.getScriptName() + " medium"); }
	if (ns.args.length == 1) { selectedSetName = ns.args[0]; }
